...
import 'package:oxytocin/features/book_appointment/presentation/viewmodels/booking_state.dart';
      ...
      listener: (context, state) {
        if (state is BookingLoading) {
          ...
          Helper.customToastification(
            ...
            description: context.tr.appointment_success,
            seconds: 5,
          );
          final response = state.bookedAppointment;
          NavigationService().pushReplacementWithParams(
            RouteNames.appointmentSuccessfullyBooked,
            extra: {"bookedAppointmentModel": response},
          );
        }
      },
