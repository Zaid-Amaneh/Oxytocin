...
class ReAppointmentAppBar extends StatefulWidget
    implements PreferredSizeWidget {
  const ReAppointmentAppBar({
    super.key,
  ...
  @override
  State<ReAppointmentAppBar> createState() => _ReAppointmentAppBarState();

  @override
  Size get preferredSize => const Size.fromHeight(60.0);
}

class _ReAppointmentAppBarState extends State<ReAppointmentAppBar> {
